...
#SBATCH -J sample_minuta_align.sh
set -e
set -u

module load gmap/2014-05-15
sh slurm-scripts/sample_minuta_align.sh

python /home/jolyang/bin/send_email.py -s slurm-scripts/sample_minuta_align_run.sh
